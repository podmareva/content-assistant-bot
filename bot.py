        ...
        try:
            ...
            for block_start in range(1, int(days) + 1, 5):
                ...
                prompt = (
                    ...
                    "- Каждый блок должен быть уникальным, добавлять новые форматы, рубрики, механики."
                    "- Контент должен развиваться: 
                       1–5 дни → знакомство и вовлечение,
                       6–10 → экспертность и доверие,
                       11–15 → прогрев и кейсы,
                       16–20 → продажи, офферы,
                       21–25 → вирусные и вовлекающие,
                       26–30 → закрепление доверия и призывы к действию.
					...
					+ "\n\n⚠️ ВАЖНО: Не повторяй темы, CTA, форматы и идеи, которые уже использовались в предыдущих блоках. " \
